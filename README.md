...
3. Enter 192.168.41.1 into the IP Box for the Project Blue COntrol Station html file - try pinging the board from the ping button
4. Click COnnect - to connect to the Milk V Duo S board - the desktop should appear and start streaming
